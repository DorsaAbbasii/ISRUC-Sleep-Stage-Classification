...
print("\nStarting tuned GBM 6-channel experiment...")
...
tuning_results_path = RESULTS_DIR / "isruc_gbm_6ch_tuning_results.csv"
...
report_path = RESULTS_DIR / "isruc_gbm_tuned_6ch_report.txt"

with open(report_path, "w", encoding="utf-8") as f:
    f.write("ISRUC Sleep Staging Tuned GBM 6-Channel EEG Baseline\n")
    f.write("====================================================\n\n")
