...
results_path = RESULTS_DIR / "isruc_gbm_6ch_enhanced_repeated_splits.csv"
report_path = RESULTS_DIR / "isruc_gbm_6ch_enhanced_repeated_splits_report.txt"

results_df.to_csv(results_path, index=False, encoding="utf-8-sig")

with open(report_path, "w", encoding="utf-8") as f:
    f.write("ISRUC Enhanced 6-Channel Tuned GBM Repeated Subject-wise Splits\n")
    f.write("================================================================\n\n")
